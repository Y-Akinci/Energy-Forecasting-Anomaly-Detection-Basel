...
MODELING FRAMEWORK
==================
Trainiert Modelle mit Cross-Validation und speichert Ergebnisse
"""
...
results.append(train_and_evaluate(ridge_model, "Ridge", ridge_params))
